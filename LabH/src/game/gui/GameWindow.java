...
public class GameWindow extends JFrame {
	...
	public void checkEnemyState() {
		if (!gameWorld.isEnemysAlive()) {
			this.gameOver(true);
			System.out.println("CHECKING ENEMYS");
		}
	}

    public void gameOver(boolean win) {
		JOptionPane.showMessageDialog(this, win ? "YOU WON" : "YOU DIED.", "Game over", JOptionPane.ERROR_MESSAGE, icon);
		System.exit(0);
    }
