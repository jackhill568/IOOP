...
public class GameHarness {
    ...
    public static void main(String[] args) {
        ...
        books = new Book[4];
        books[0] = new SkillBook("Sword Mastery", "K. Steel", 250, "Sword Fighting");
        books[1] = new SkillBook("Herbal Remedies", "L. Green", 180, "Healing");
        books[2] = new SkillBook("Secrets of the Arcane", "M. Rune", 320, "Spellcasting");
